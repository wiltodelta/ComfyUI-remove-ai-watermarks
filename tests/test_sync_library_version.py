...
[project]
version = "0.1.2"
dependencies = ["remove-ai-watermarks[qwen-zimage,heif]>=0.19.0"]
"""
_REQUIREMENTS = "remove-ai-watermarks[qwen-zimage,heif]>=0.19.0\n"
...
def test_sync_text_updates_both_floors_and_bumps_patch() -> None:
    ...
    assert "remove-ai-watermarks[qwen-zimage,heif]>=0.20.0" in project
    assert requirements == "remove-ai-watermarks[qwen-zimage,heif]>=0.20.0\n"
